...
urlpatterns = patterns('',
	...
	url(r'^queues/(?P<queue_name>.+?)/close$', 'openlavaweb.views.queue_close', name="olw_queue_close"),
	url(r'^queues/(?P<queue_name>.+?)/open$', 'openlavaweb.views.queue_open', name="olw_queue_open"),
	url(r'^queues/(?P<queue_name>.+?)/inactivate$', 'openlavaweb.views.queue_inactivate', name="olw_queue_inactivate"),
	url(r'^queues/(?P<queue_name>.+?)/activate$', 'openlavaweb.views.queue_activate', name="olw_queue_activate"),
