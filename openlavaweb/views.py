...
class TrinityJobSubmitForm(OLWSubmit):
    ...
    inchworm_cpu=forms.ChoiceField(default=6, choices=[(x,x) for x in range(6)], help_text="Number of CPUs to use for Inchworm, defaults to the number of CPUs specified for the job, or 6, whichever is lower" )
