...
def queue_list(request):
	...
	if request.is_ajax() or request.GET.get("json",None):
		return HttpResponse(json.dumps(queue_list,sort_keys=True, indent=3, cls=ClusterEncoder),content_type='application/json')
...
def queue_view(request,queue_name):
	...
	if request.is_ajax() or request.GET.get("json",None):
		return HttpResponse(json.dumps(queue,sort_keys=True, indent=3, cls=ClusterEncoder),content_type='application/json')
...
def host_view(request,host_name):
	...
	if request.is_ajax() or request.GET.get("json",None):
		return HttpResponse(json.dumps(host, sort_keys=True, indent=3, cls=ClusterEncoder),content_type='application/json')
...
def host_list(request):
	...
	if request.is_ajax() or request.GET.get("json",None):
		return HttpResponse(json.dumps(host_list, sort_keys=True, indent=3, cls=ClusterEncoder),content_type='application/json')
...
def user_list(request):
	...
	if request.is_ajax() or request.GET.get("json",None):
		return HttpResponse(json.dumps(user_list, sort_keys=True, indent=3, cls=ClusterEncoder),content_type='application/json')
...
def user_view(request,user_name):
	...
	if request.is_ajax() or request.GET.get("json",None):
		return HttpResponse(json.dumps(user, sort_keys=True, indent=3, cls=ClusterEncoder),content_type='application/json')
...
def system_view(request):
	cluster=Cluster()
	if request.is_ajax() or request.GET.get("json",None):
		return HttpResponse(json.dumps(cluster, sort_keys=True, indent=3, cls=ClusterEncoder), content_type="application/json")
